...
sub closing_target_trimming {
         ...
         if($trimmed_gdna){
           ...
           #short sequence is not further analyzed
            ...
            #low gw_score is not reliable
              ...
              my ($target_gdna)=($wise_parse1=~/\&\&\&\&(.*)/);         
              my $target_head= ">".$id." \| ".$align_ratio." \| ".$percent_identity." \| ".$hit_name;
 ...
 print "trimmed=",$trimmed_seqs,"\n";
  ...
  my @ctt_result=(\@adjusted_gdnas, $summary);
