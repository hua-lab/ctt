...
use Bio::DB::Fasta;
  ...
  my $family_seed="./seeds/FBX_PF00646_seeds.txt_newnr100";    
  ...
  while(my $org=<ORGANISMS>) {
    ...
    @unique_hits=('Chr3-:10587601:10587720');
    ...
    my $tblastn_parse_file="./step3_output/tblastn_parse_result_check".$genome;
...
print "total_new=", scalar @putative_new_loci,"\n";
